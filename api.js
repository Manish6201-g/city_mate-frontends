...
export const requestPasswordReset = (email) =>
  api('/api/admin/forgot-password', { method: 'POST', body: { email } });

export const resetPassword = (token, newPassword) =>
  api('/api/admin/reset-password', { method: 'POST', body: { token, newPassword } });
...
export const getAdmins = () => api('/api/admin/admins');
export const createAdmin = (data) => api('/api/admin/admins', { method: 'POST', body: data });
export const deleteAdmin = (id) => api(`/api/admin/admins/${id}`, { method: 'DELETE' });
